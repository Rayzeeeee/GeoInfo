pays = {  # Dictionnaire de tous les pays du monde

    "Afrique_du_Sud": {
            "Capitale": "Pretoria",
            "Président": "Cyril Ramaphosa",
            "Superficie": "1,221,037 km²",
            "Population": "61 525 521 habitants",
            "Wikipédia": "https://fr.wikipedia.org/wiki/Afrique_du_Sud"
        },
        "Algérie": {
            "Capitale": "Alger",
   ...
   #Europe
    ...
    "Allemagne": {
        ...
        "Population": "83 783 942 habitants",
        "Wikipédia": "https://fr.wikipedia.org/wiki/Allemagne"
    },
    "Italie": {
        "Capitale": "Rome",
...
Recherche = input("Entrer un pays du monde pour en savoir plus :")  # Demande à l'utilisateur d'entrer un pays à rechercher
...
if Recherche in pays:                                             # Si Le pays rentrer et dans le dictionnaire des pays
    ...
    for titre, info_titre in info_pays.items():                           # Boucle pour afficher les informations du pays
        print(f"{titre}: {info_titre}")                                   # Affichage des informations
    print("-----------------------------------------------------")
else:
