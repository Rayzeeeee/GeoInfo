...
root.iconbitmap('Ressources\Icons\Earth_design.ico') # Icone de la fenêtre
...
PIL_logo = Image.open("Ressources\Icons\Earth_design.png")
...
# Bouton de recherche
PIL_valider = Image.open("Ressources\Icons\loupe.png")
...
PIL_retour = Image.open("Ressources\Icons\Retour.png")
...
pays_drapeau = {
    "Afghanistan": r"Ressources\Drapeau_pays\af.png",
    "Algérie": r"Ressources\Drapeau_pays\dz.png",
    "Angola": r"Ressources\Drapeau_pays\ao.png",
    "Antigua-et-Barbuda": r"Ressources\Drapeau_pays\ag.png",
    "Argentine": r"Ressources\Drapeau_pays\ar.png",
    "Arménie": r"Ressources\Drapeau_pays\am.png",
    "Australie": r"Ressources\Drapeau_pays\au.png",
    "Autriche": r"Ressources\Drapeau_pays\at.png",
    "Azerbaïdjan": r"Ressources\Drapeau_pays\az.png",
    "Bahamas": r"Ressources\Drapeau_pays\bs.png",
    "Bahreïn": r"Ressources\Drapeau_pays\bh.png",
    "Bangladesh": r"Ressources\Drapeau_pays\bd.png",
    "Barbade": r"Ressources\Drapeau_pays\bb.png",
    "Belgique": r"Ressources\Drapeau_pays\be.png",
    "Belize": r"Ressources\Drapeau_pays\bz.png",
    "Bénin": r"Ressources\Drapeau_pays\bj.png",
    "Bhoutan": r"Ressources\Drapeau_pays\bt.png",
    "Biélorussie": r"Ressources\Drapeau_pays\by.png",
    "Birmanie": r"Ressources\Drapeau_pays\mm.png",
    "Bolivie": r"Ressources\Drapeau_pays\bo.png",
    "Bosnie-Herzégovine": r"Ressources\Drapeau_pays\ba.png",
    "Botswana": r"Ressources\Drapeau_pays\bw.png",
    "Brésil": r"Ressources\Drapeau_pays\br.png",
    "Brunei": r"Ressources\Drapeau_pays\bn.png",
    "Bulgarie": r"Ressources\Drapeau_pays\bg.png",
    "Burkina Faso": r"Ressources\Drapeau_pays\bf.png",
    "Burundi": r"Ressources\Drapeau_pays\bi.png",
    "Cambodge": r"Ressources\Drapeau_pays\kh.png",
    "Cameroun": r"Ressources\Drapeau_pays\cm.png",
    "Canada": r"Ressources\Drapeau_pays\ca.png",
    "Cap-Vert": r"Ressources\Drapeau_pays\cv.png",
    "République centrafricaine": r"Ressources\Drapeau_pays\cf.png",
    "Tchad": r"Ressources\Drapeau_pays\td.png",
    "Chili": r"Ressources\Drapeau_pays\cl.png",
    "Chine": r"Ressources\Drapeau_pays\cn.png",
    "Colombie": r"Ressources\Drapeau_pays\co.png",
    "Comores": r"Ressources\Drapeau_pays\km.png",
    "République du Congo": r"Ressources\Drapeau_pays\cg.png",
    "République démocratique du Congo": r"Ressources\Drapeau_pays\cd.png",
    "Îles Cook": r"Ressources\Drapeau_pays\ck.png",
    "Costa Rica": r"Ressources\Drapeau_pays\cr.png",
    "Côte d'Ivoire": r"Ressources\Drapeau_pays\ci.png",
    "Croatie": r"Ressources\Drapeau_pays\hr.png",
    "Cuba": r"Ressources\Drapeau_pays\cu.png",
    "Chypre": r"Ressources\Drapeau_pays\cy.png",
    "République tchèque": r"Ressources\Drapeau_pays\cz.png",
    "Danemark": r"Ressources\Drapeau_pays\dk.png",
    "Djibouti": r"Ressources\Drapeau_pays\dj.png",
    "Dominique": r"Ressources\Drapeau_pays\dm.png",
    "République dominicaine": r"Ressources\Drapeau_pays\do.png",
    "Équateur": r"Ressources\Drapeau_pays\ec.png",
    "Égypte": r"Ressources\Drapeau_pays\eg.png",
    "Salvador": r"Ressources\Drapeau_pays\sv.png",
    "Guinée équatoriale": r"Ressources\Drapeau_pays\gq.png",
    "Érythrée": r"Ressources\Drapeau_pays\er.png",
    "Estonie": r"Ressources\Drapeau_pays\ee.png",
    "Eswatini": r"Ressources\Drapeau_pays\sz.png",
    "Éthiopie": r"Ressources\Drapeau_pays\et.png",
    "Fidji": r"Ressources\Drapeau_pays\fj.png",
    "Finlande": r"Ressources\Drapeau_pays\fi.png",
    "France": r"Ressources\Drapeau_pays\fr.png",
    "Gabon": r"Ressources\Drapeau_pays\ga.png",
    "Gambie": r"Ressources\Drapeau_pays\gm.png",
    "Géorgie": r"Ressources\Drapeau_pays\ge.png",
    "Allemagne": r"Ressources\Drapeau_pays\de.png",
    "Ghana": r"Ressources\Drapeau_pays\gh.png",
    "Grèce": r"Ressources\Drapeau_pays\gr.png",
    "Grenade": r"Ressources\Drapeau_pays\gd.png",
    "Guatemala": r"Ressources\Drapeau_pays\gt.png",
    "Guinée": r"Ressources\Drapeau_pays\gn.png",
    "Guinée-Bissau": r"Ressources\Drapeau_pays\gw.png",
    "Guyana": r"Ressources\Drapeau_pays\gy.png",
    "Haïti": r"Ressources\Drapeau_pays\ht.png",
    "Honduras": r"Ressources\Drapeau_pays\hn.png",
    "Hongrie": r"Ressources\Drapeau_pays\hu.png",
    "Islande": r"Ressources\Drapeau_pays\is.png",
    "Inde": r"Ressources\Drapeau_pays\in.png",
    "Indonésie": r"Ressources\Drapeau_pays\id.png",
    "Iran": r"Ressources\Drapeau_pays\ir.png",
    "Irak": r"Ressources\Drapeau_pays\iq.png",
    "Irlande": r"Ressources\Drapeau_pays\ie.png",
    "Israël": r"Ressources\Drapeau_pays\il.png",
    "Italie": r"Ressources\Drapeau_pays\it.png",
    "Jamaïque": r"Ressources\Drapeau_pays\jm.png",
    "Japon": r"Ressources\Drapeau_pays\jp.png",
    "Jordanie": r"Ressources\Drapeau_pays\jo.png",
    "Kazakhstan": r"Ressources\Drapeau_pays\kz.png",
    "Kenya": r"Ressources\Drapeau_pays\ke.png",
    "Kiribati": r"Ressources\Drapeau_pays\ki.png",
    "Corée du Nord": r"Ressources\Drapeau_pays\kp.png",
    "Corée du Sud": r"Ressources\Drapeau_pays\kr.png",
    "Koweït": r"Ressources\Drapeau_pays\kw.png",
    "Kirghizistan": r"Ressources\Drapeau_pays\kg.png",
    "Laos": r"Ressources\Drapeau_pays\la.png",
    "Lettonie": r"Ressources\Drapeau_pays\lv.png",
    "Liban": r"Ressources\Drapeau_pays\lb.png",
    "Lesotho": r"Ressources\Drapeau_pays\ls.png",
    "Liberia": r"Ressources\Drapeau_pays\lr.png",
    "Libye": r"Ressources\Drapeau_pays\ly.png",
    "Liechtenstein": r"Ressources\Drapeau_pays\li.png",
    "Lituanie": r"Ressources\Drapeau_pays\lt.png",
    "Luxembourg": r"Ressources\Drapeau_pays\lu.png",
    "Madagascar": r"Ressources\Drapeau_pays\mg.png",
    "Malawi": r"Ressources\Drapeau_pays\mw.png",
    "Malaisie": r"Ressources\Drapeau_pays\my.png",
    "Maldives": r"Ressources\Drapeau_pays\mv.png",
    "Mali": r"Ressources\Drapeau_pays\ml.png",
    "Malte": r"Ressources\Drapeau_pays\mt.png",
    "Îles Marshall": r"Ressources\Drapeau_pays\mh.png",
    "Mauritanie": r"Ressources\Drapeau_pays\mr.png",
    "Maurice": r"Ressources\Drapeau_pays\mu.png",
    "Mexique": r"Ressources\Drapeau_pays\mx.png",
    "Micronésie": r"Ressources\Drapeau_pays\fm.png",
    "Moldavie": r"Ressources\Drapeau_pays\md.png",
    "Monaco": r"Ressources\Drapeau_pays\mc.png",
    "Mongolie": r"Ressources\Drapeau_pays\mn.png",
    "Monténégro": r"Ressources\Drapeau_pays\me.png",
    "Maroc": r"Ressources\Drapeau_pays\ma.png",
    "Mozambique": r"Ressources\Drapeau_pays\mz.png",
    "Namibie": r"Ressources\Drapeau_pays\na.png",
    "Nauru": r"Ressources\Drapeau_pays\nr.png",
    "Népal": r"Ressources\Drapeau_pays\np.png",
    "Pays-Bas": r"Ressources\Drapeau_pays\nl.png",
    "Nouvelle-Zélande": r"Ressources\Drapeau_pays\nz.png",
    "Nicaragua": r"Ressources\Drapeau_pays\ni.png",
    "Niger": r"Ressources\Drapeau_pays\ne.png",
    "Nigéria": r"Ressources\Drapeau_pays\ng.png",
    "Macédoine du Nord": r"Ressources\Drapeau_pays\mk.png",
    "Norvège": r"Ressources\Drapeau_pays\no.png",
    "Oman": r"Ressources\Drapeau_pays\om.png",
    "Pakistan": r"Ressources\Drapeau_pays\pk.png",
    "Palau": r"Ressources\Drapeau_pays\pw.png",
    "Palestine": r"Ressources\Drapeau_pays\ps.png",
    "Panama": r"Ressources\Drapeau_pays\pa.png",
    "Papouasie-Nouvelle-Guinée": r"Ressources\Drapeau_pays\pg.png",
    "Paraguay": r"Ressources\Drapeau_pays\py.png",
    "Pérou": r"Ressources\Drapeau_pays\pe.png",
    "Philippines": r"Ressources\Drapeau_pays\ph.png",
    "Pologne": r"Ressources\Drapeau_pays\pl.png",
    "Portugal": r"Ressources\Drapeau_pays\pt.png",
    "Qatar": r"Ressources\Drapeau_pays\qa.png",
    "Roumanie": r"Ressources\Drapeau_pays\ro.png",
    "Russie": r"Ressources\Drapeau_pays\ru.png",
    "Rwanda": r"Ressources\Drapeau_pays\rw.png",
    "Saint-Christophe-et-Niévès": r"Ressources\Drapeau_pays\kn.png",
    "Sainte-Lucie": r"Ressources\Drapeau_pays\lc.png",
    "Saint-Vincent-et-les-Grenadines": r"Ressources\Drapeau_pays\vc.png",
    "Samoa": r"Ressources\Drapeau_pays\ws.png",
    "Saint-Marin": r"Ressources\Drapeau_pays\sm.png",
    "Sao Tomé-et-Principe": r"Ressources\Drapeau_pays\st.png",
    "Arabie saoudite": r"Ressources\Drapeau_pays\sa.png",
    "Sénégal": r"Ressources\Drapeau_pays\sn.png",
    "Serbie": r"Ressources\Drapeau_pays\rs.png",
    "Seychelles": r"Ressources\Drapeau_pays\sc.png",
    "Sierra Leone": r"Ressources\Drapeau_pays\sl.png",
    "Singapour": r"Ressources\Drapeau_pays\sg.png",
    "Slovaquie": r"Ressources\Drapeau_pays\sk.png",
    "Slovénie": r"Ressources\Drapeau_pays\si.png",
    "Îles Salomon": r"Ressources\Drapeau_pays\sb.png",
    "Somalie": r"Ressources\Drapeau_pays\so.png",
    "Afrique du Sud": r"Ressources\Drapeau_pays\za.png",
    "Soudan du Sud": r"Ressources\Drapeau_pays\ss.png",
    "Espagne": r"Ressources\Drapeau_pays\es.png",
    "Sri Lanka": r"Ressources\Drapeau_pays\lk.png",
    "Soudan": r"Ressources\Drapeau_pays\sd.png",
    "Suriname": r"Ressources\Drapeau_pays\sr.png",
    "Suède": r"Ressources\Drapeau_pays\se.png",
    "Suisse": r"Ressources\Drapeau_pays\ch.png",
    "Syrie": r"Ressources\Drapeau_pays\sy.png",
    "Taïwan": r"Ressources\Drapeau_pays\tw.png",
    "Tadjikistan": r"Ressources\Drapeau_pays\tj.png",
    "Tanzanie": r"Ressources\Drapeau_pays\tz.png",
    "Thaïlande": r"Ressources\Drapeau_pays\th.png",
    "Timor oriental": r"Ressources\Drapeau_pays\tl.png",
    "Togo": r"Ressources\Drapeau_pays\tg.png",
    "Tonga": r"Ressources\Drapeau_pays\to.png",
    "Trinité-et-Tobago": r"Ressources\Drapeau_pays\tt.png",
    "Tunisie": r"Ressources\Drapeau_pays\tn.png",
    "Turquie": r"Ressources\Drapeau_pays\tr.png",
    "Turkménistan": r"Ressources\Drapeau_pays\tm.png",
    "Tuvalu": r"Ressources\Drapeau_pays\tv.png",
    "Ouganda": r"Ressources\Drapeau_pays\ug.png",
    "Ukraine": r"Ressources\Drapeau_pays\ua.png",
    "Émirats arabes unis": r"Ressources\Drapeau_pays\ae.png",
    "Royaume-Uni": r"Ressources\Drapeau_pays\gb.png",
    "États-Unis": r"Ressources\Drapeau_pays\us.png",
    "Uruguay": r"Ressources\Drapeau_pays\uy.png",
    "Ouzbékistan": r"Ressources\Drapeau_pays\uz.png",
    "Vanuatu": r"Ressources\Drapeau_pays\vu.png",
    "Vatican": r"Ressources\Drapeau_pays\va.png",
    "Venezuela": r"Ressources\Drapeau_pays\ve.png",
    "Viêt Nam": r"Ressources\Drapeau_pays\vn.png",
    "Yémen": r"Ressources\Drapeau_pays\ye.png",
    "Zambie": r"Ressources\Drapeau_pays\zm.png",
    "Zimbabwe": r"Ressources\Drapeau_pays\zw.png"
}
