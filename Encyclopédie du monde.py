...
root.geometry("500x300") # Résolution de la fenêtre
...
def verif_recherche(e):
    ...
    update(data) # Mettre à jour la list box avec les pays filtrés
...
update(pays) # Mise à jour de la listbox avec tous les pays
